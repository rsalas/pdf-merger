...
class PDFMerger
{
	 ...
	 * @return void
	 */
	public function addPDF($filepath, $pages = 'all',$orientation='P')
	{
		...
		{
			error_log("Could not locate PDF on '$filepath'");
		}
	...
	public function merge($outputmode = 'browser', $outputpath = 'newfile.pdf')
	{
		...
		else
		{
			...
			{
				error_log("Error outputting PDF to '$outputmode'.");
				return false;
			}
		}
	...
	private function _rewritepages($pages)
	{
		...
		foreach($part as $i)
		{
			...
			if(count($ind) == 2)
			{
				...
				if($x > $y): error_log("Starting page, '$x' is greater than ending page '$y'."); return false; endif;
